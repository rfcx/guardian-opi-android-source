...
public class CalendarUtilities {
    ...
    static public EmailContent.Message createMessageForEventId(Context context, long eventId,
        ...
        Cursor event = cr.query(ContentUris.withAppendedId(Events.CONTENT_URI, eventId), null, null, null, null);
        if (event == null) {
            LogUtils.w(TAG,
                    "createMessageForEventId failed, query Event [%d] is null", eventId);
            return null;
        }
        EntityIterator eventIterator = EventsEntity.newEntityIterator(event, cr);
        /// @}
