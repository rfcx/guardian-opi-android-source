...
public class HotKnotHandler implements
    ...
    public static void register(ContactDetailFragment contactFragment) {
        Log.d(TAG, "HotKnotHandler register");
        if (contactFragment == null) {
            Log.d(TAG, "ContactDetailFragment is null!");
            return;
        }

        Activity activity = contactFragment.getActivity();
        ...
        Uri contactUri = contactFragment.getUri();
        if (contactUri != null) {
