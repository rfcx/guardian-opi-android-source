 ...
 */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedState) {
        ...
        if (ISTABLET_LAND) {  
            ...
            mIpCallContainer = view.findViewById(R.id.ip_call_container);
        }
        return view;
    }
...
//                                !isAutoRejectedFilterMode(), ExtensionManager.COMMD_FOR_OP01);
...
//    }
    ...
    private void configureCallButton(ViewEntry entry) {
        ...
        //
        if (mHasVoiceMail) {
            if (null != mIpCallContainer) {
                mIpCallContainer.setVisibility(View.GONE);
            }
        } else {
            if (null != mConvertView2) {
                mConvertView2.setVisibility(View.VISIBLE);
            } else {
                Log.i(TAG, "mConvertView2 is null");
                return;
            }
