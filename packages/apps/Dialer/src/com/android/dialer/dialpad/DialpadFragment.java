...
import com.mediatek.dialer.dialpad.DialerSearchController;
...
/** @ }*/
    ...
    private final PhoneStateListener mPhoneStateListener = new PhoneStateListener() {
        ...
        public void onServiceStateChanged(ServiceState serviceState) {
            ...
            String newIso = GeoUtil.getCurrentCountryIso(getActivity());
...
//        }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.dialButton: {
                ...
                LogUtils.i("sera","[Performance test][Phone] Call_Performance_004 start [" + System.currentTimeMillis() + "]");
                /// M: @}
        ...
        switch (id) {
            ...
            case R.id.one: {
                ...
                if (isDigitsEmpty() || TextUtils.equals(mDigits.getText(), "1")) {
                    /// M: ALPS01457218
                    // If SIP Call, should not dial voice mail number.
    ...
    */
    ...
    private void returnToInCallScreen(boolean showDialpad) {
        ...
        /// M: Fix CR: ALPS01534298. @{
        // Do not finish DialtactsActivity when click return to incallscreen menu item,
        // keep the same behavior with jelly bean. Or else may affect CMCC MTBF.
        // original code:
        // getActivity().finish();
        /// @}
    ...
    private static SpeedDial mSpeedDial;
   ...
   /* protected void showDialpad(boolean show) {
    ...
    private void showSpeedDialConfirmDialog() {
        ...
        if (activity.isSafeToCommitTransactions()) {
            DialogFragment speedDialogConfirmDialogFragment = ConfirmDialogFragment.newInstance();
            speedDialogConfirmDialogFragment.show(getFragmentManager(), ConfirmDialogFragment.FRAGMENT_TAG);
        }
    }
