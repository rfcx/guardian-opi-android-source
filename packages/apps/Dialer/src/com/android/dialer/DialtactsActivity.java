...
import com.mediatek.dialer.ext.SetIndicatorUtils;
...
import com.mediatek.dialer.util.PDebug;
...
public class DialtactsActivity extends TransactionSafeActivity implements View.OnClickListener,
    ...
    */
    ...
    private final TextWatcher mPhoneSearchQueryTextListener = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            if (TextUtils.isEmpty(newText) && getInSearchUi()) {
                ...
                /// M: fix CR: ALPS01476416, ensure the correct visible status of CLOSE button @{
                mIsCloseButtonVisible = false;
                /// M: @}
                /**
                 * M:original code:
                ...
                /// M: fix CR: ALPS01476697, Should set close_button visible when the text is not empty @{
                mSearchViewCloseButton.setVisibility(View.VISIBLE);
                /// M: fix CR: ALPS01476416, ensure the correct visible status of CLOSE button @{
                mIsCloseButtonVisible = true;
                /// M: @}
                /// M: @}
    ...
    protected void onCreate(Bundle savedInstanceState) {
        PDebug.Start("DialtactsActivity.onCreate");
        ...
        if (savedInstanceState == null) {
            ...
            /// M: fix CR: ALPS01476416, ensure the correct visible status of CLOSE button @{
            mIsCloseButtonVisible = savedInstanceState.getBoolean(KEY_CLOSE_BUTTON_VISIBLE);
            /// M: @}
        }
        ...
        /// M: for MTK-DialerSearch @{
        DialerSearchHelper.getInstance(getApplicationContext()).dialerSearchUpdateAsync();
        /// @}
        PDebug.End("DialtactsActivity.onCreate");
    }

    @Override
    protected void onResume() {
        PDebug.Start("DialtactsActivity.onResume");
        super.onResume();
        if (mFirstLaunch) {
            /// M: Fix CR: ALPS01260630, Time lag issues @{
        ...
        PDebug.End("DialtactsActivity.onResume");
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        /// M: fix CR: ALPS01476416, ensure the correct visible status of CLOSE button @{
        outState.putBoolean(KEY_CLOSE_BUTTON_VISIBLE, mIsCloseButtonVisible);
        /// M: @}
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.overflow_menu: {
                /// M: ALPS01437069 Memory Leak.
                // 1. Dismiss the exist PopupWindow if user touch too quickly.
                // 2. FW release views cached in PopupWindow.
    ...
    */
    ...
    private boolean isDialIntent(Intent intent) {
        ...
        return ExtensionManager.getInstance().getDialtactsExtension().checkComponentName(intent,
                ExtensionManager.COMMD_FOR_OP01);
        /** @} */
...
/*
    ...
    private void enterSearchUi(boolean smartDialSearch, String query) {
        ...
        final FragmentTransaction transaction = getFragmentManager().beginTransaction();
        /// M: modify for ALPS01416290.@{
        // once we use animation in fast frequent operation, it will cause fragment problems.
        //original code:
    ...
    private void exitSearchUi() {
        ...
        /// M: modify for ALPS01416290 ALPS01285522 ALPS01380190.@{
        // if we put the "commit" and "pop up" action into Transaction queue
        // quickly and frequently , it will cause some fragment problems.
        /* Original code: 
        ...
        try {
            ...
            LogUtils.w(TAG, "exitSearchUi() popBackStackImmediate Fail! "+e.getMessage());
        }
        /// @}
        setNotInSearchUi();
    ...
    /// M: fix CR: ALPS01476416, ensure the correct visible status of CLOSE button @{
    private boolean mIsCloseButtonVisible = false;
    private static final String KEY_CLOSE_BUTTON_VISIBLE = "close_button_visible";
    /// M: @}
