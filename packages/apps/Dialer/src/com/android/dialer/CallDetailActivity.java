    ...
    private void updateData(final Uri... callUris) {
        class UpdateContactDetailsTask extends AsyncTask<Void, Void, PhoneCallDetailsEx[]> {
            ...
            public void onPostExecute(PhoneCallDetailsEx[] details) {
                ...
                final boolean isEmergencyNumber = mPhoneNumberHelper.isEmergencyNumber(mNumber, firstDetails.simId);
                ...
                */
                ...
                /// @}
                    ...
                    mainActionIntent = null;
                    mainActionIcon = 0;
                    mainActionDescription = getString(R.string.voicemail);
                } else if (isEmergencyNumber){
                    mainActionIntent = null;
                    mainActionIcon = 0;
                    mainActionDescription = getString(R.string.emergencycall);
...
//                }
                ...
                if (mainActionIntent == null) {
                    if (isEmergencyNumber || isVoicemailNumber) {
                        ...
                        mMainActionPushLayerView.setVisibility(View.INVISIBLE);
