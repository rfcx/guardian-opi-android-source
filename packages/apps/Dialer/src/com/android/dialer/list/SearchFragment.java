...
import com.mediatek.dialer.DialerSearchHelper.DialerSearchContentChangeListener;
import com.mediatek.dialer.util.LogUtils;

public class SearchFragment extends PhoneNumberPickerFragment implements DialerSearchContentChangeListener {
    ...
    public void onResume() {
        super.onResume();
        DialerSearchHelper.getInstance(getContext()).registerForContentChange(this);
    }

    @Override
    public void onStop() {
        super.onStop();
        DialerSearchHelper.getInstance(getContext()).unRegisterForContentChange(this);
    }
    ...
    @Override
    public void onDialerSeachContentChange() {
        mHandler.sendMessage(mHandler.obtainMessage(DIALER_SEARCH_CONTENT_CHANGE));
