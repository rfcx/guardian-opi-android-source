...
public class PhoneFavoriteFragment extends Fragment implements OnItemClickListener,
    ...
    private class ContactTileLoaderListener implements LoaderManager.LoaderCallbacks<Cursor> {
        ...
        public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
            ...
            PDebug.End("PhoneFavoriteFragment.Loading");
        }
    ...
    public void onCreate(Bundle savedState) {
        PDebug.Start("PhoneFavoriteFragment.onCreate");
        ...
        PDebug.EndAndStart("PhoneFavoriteFragment.onCreate", "PhoneFavoriteFragment.onStart");
    }
    ...
    public void onResume() {
        ...
        PDebug.EndAndStart("PhoneFavoriteFragment.onResume", "PhoneFavoriteFragment.Loading");
    ...
    public void onStart() {
        ...
        PDebug.EndAndStart("PhoneFavoriteFragment.onStart", "PhoneFavoriteFragment.onResume");
    }
    ...
    public void fetchCalls() {
        ...
        if (activity == null) {
            ...
            /// M: Fix CR:ALPS01505687, Should use FILTER_TYPE_ALL to query. @{
            /** original code:
            ...
            */
            mCallLogQueryHandler.fetchCallsJionDataView(simFilter, Constants.FILTER_TYPE_ALL, mLastCallShortcutDate);
        }
        /// @}
    }
