...
public class BluetoothMapMessageListingElement
    ...
    {
        if (!BluetoothMapUtils.islegalArgument(subject)
                || !BluetoothMapUtils.islegalArgument(recipientName)
                || !BluetoothMapUtils.islegalArgument(recipientAddressing)
                || !BluetoothMapUtils.islegalArgument(senderName)
                || !BluetoothMapUtils.islegalArgument(senderAddressing)
                || !BluetoothMapUtils.islegalArgument(replytoAddressing)) {
            return;
        }
