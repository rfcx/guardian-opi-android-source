...
public class NumberPickerDialogChannel extends Activity implements
	...
	private int val_tx = Utils.readIntFromSharePreference("channel_ctdcss_tx",
			defVal_numPicker);
	private int val_rx = Utils.readIntFromSharePreference("channel_ctdcss_rx",
			defVal_numPicker);
	...
	private void initView() {
		...
		mNumberPickerTx.setValue(Utils.readIntFromSharePreference(
				"channel_ctdcss_tx", defVal_numPicker));
		...
		mNumberPickerRx.setValue(Utils.readIntFromSharePreference(
				"channel_ctdcss_rx", defVal_numPicker));
	...
	public void onClick(View view) {
		...
		switch (id) {
		case R.id.ok:
			Utils.writeIntToSharePreference("channel_ctdcss_tx", val_tx);
			val_tx = Utils.readIntFromSharePreference("channel_ctdcss_tx",
					defVal_numPicker);
			Utils.writeIntToSharePreference("channel_ctdcss_rx", val_rx);
			val_rx = Utils.readIntFromSharePreference("channel_ctdcss_rx",
					defVal_numPicker);
			break;
		case R.id.back:
			val_tx = Utils.readIntFromSharePreference("channel_ctdcss_tx",
		...
		it.putExtra("channel_ctdcss_tx", val_tx);
		it.putExtra("channel_ctdcss_rx", val_rx);
