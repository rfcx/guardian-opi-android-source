...
class DeviceProfile {
    ...
    void updateFromConfiguration(Resources resources, int wPx, int hPx,
        ...
        /// M: [ALPS01413082] Add all apps icon margin, so that column number of apps list will be
        /// calculated to 4 for hdpi project.
        int allAppsIconMarginPx = resources.getDimensionPixelSize(R.dimen.dynamic_grid_all_apps_icon_margin);
        allAppsNumCols = (availableWidthPx - padding.left - padding.right - 2 * edgeMarginPx) /
                (iconSizePx + 2 * edgeMarginPx + 2 * allAppsIconMarginPx);
    }
