...
public class BubbleTextView extends TextView {
    ...
    public void applyFromShortcutInfo(ShortcutInfo info, IconCache iconCache) {
        ...
        /// M: [ALPS01377308] Do not set drawable padding if resolution is small.
        Point realSize = new Point();
        ((WindowManager)getContext().getSystemService(Context.WINDOW_SERVICE)).getDefaultDisplay().getRealSize(realSize);
        if (!(realSize.x <= 480 && realSize.y <= 800)) {
