...
public class WallpaperCropActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		Log.i(LOGTAG, "WallpaperCropActivity.onCreate done!");
    }

	@Override
    protected void onResume() {
        super.onResume();
        Log.i(LOGTAG, "WallpaperCropActivity.onResume");
    }
    ...
    private static int getRotationFromExifHelper(
        ...
        try {
            ...
            if (ori != null) {
                result = ExifInterface.getRotationForOrientationValue(ori.shortValue());
            }
        } catch (IOException e) {
    ...
    public static class BitmapCropTask extends AsyncTask<Void, Void, Boolean> {
        ...
        public boolean cropBitmap() {
            ...
            if (mSetWallpaper && mNoCrop && mInStream != null) {
                try {
                    wallpaperManager.setStreamWithDimensions(mInStream, mCropWidth, mCropHeight);
                } catch (IOException e) {
                ...
                if (crop.compress(cf, DEFAULT_COMPRESS_QUALITY, tmpOut)) {
                    ...
                    if (mSetWallpaper && wallpaperManager != null) {
                        try {
                            ...
                            wallpaperManager.setStreamWithDimensions(new ByteArrayInputStream(outByteArray), mCropWidth, mCropHeight);
