                    ...
                    public boolean onTouch(View v, MotionEvent event) {
                        if (event.getAction() == MotionEvent.ACTION_DOWN) {
                            if (LauncherLog.DEBUG) {
                                LauncherLog.d(TAG, "[All apps launch time][Down] dispatchTouchEvent ACTION_DOWN.");
                            }
                        } else if (event.getAction() == MotionEvent.ACTION_UP) {
                            if (LauncherLog.DEBUG) {
                                LauncherLog.d(TAG, "[All apps launch time][Up] dispatchTouchEvent ACTION_UP.");
                            }
                        }
                        View.OnTouchListener listener = mLauncher.getHapticFeedbackTouchListener();
