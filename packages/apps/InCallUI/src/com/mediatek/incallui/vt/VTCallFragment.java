...
//            hideLocalZoomOrBrightness(true);
    ...
    public void onVTSwitchCameraClick() {
        ...
        Log.i(this, "onVTSwitchCameraClick() / mVTInSwitchCamera: " + VTInCallScreenFlags.getInstance().mVTInSwitchCamera);
...
//        updateVTScreen(getVTScreenMode());
    ...
    public void onVTShowSettingClick() {
        ...
        if (!VTInCallScreenFlags.getInstance().mVTHideMeNow) {
            if (VTInCallScreenFlags.getInstance().mVTInLocalZoomSetting) {
                myBuilder.setItems(R.array.vt_incall_video_setting_entries,
    ...
    public void amendVtLayout(int callCardBottom) {
        ...
        adjustLocalVTButton(highVideoHeight, lowVideoHeight);
     ...
     */
    public void adjustLocalVTButton(int highVideoHeight, int lowVideoHeight) {
