...
public class CallCardPresenter extends Presenter<CallCardPresenter.CallCardUi>
        /**
         * M: add PhoneRecorderListener, VTListener
    ...
    */
     ...
     */
    /*
     * M: change from private to static
     * Original code:
    ...
    private long getCallDuration(Call call) {
        if (FeatureOptionWrapper.isSupportVT() && call.isVideoCall()) {
            ...
            // For ALPS01529355: The call timer will be affected when the system time changed @{
            // It's caused by using System.currentTimeMillis() to calculate call time.
            // Solution is use SystemClock.elapsedRealtime() to calculate time.
            // Original code:
            // final long callStart = call.getConnectTime();
            // final long duration = System.currentTimeMillis() - callStart;
            // return duration;
            return call.getDurationMillis();
            /// @}
        }
    }
