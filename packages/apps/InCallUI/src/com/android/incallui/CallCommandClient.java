...
public class CallCommandClient {
    ...
    /**
     * unbind callhandlerservice after ui update.
     */

	public void unbindAfterUiUpdate() {
		if (mCommandService == null) {
			Log.e(this,	"Cannot unbindAfterUIupdate(); CallCommandService == null");
			return;
		}

		try {
			Log.d(this, "unbindAfterUIupdate, msg_what");
			mCommandService.unbindAfterUiUpdate();
		} catch (RemoteException e) {
			Log.d(this, "Error on unbindAfterUiUpdate");
		}
	}
    /**
