...
public class AnswerFragment extends BaseFragment<AnswerPresenter, AnswerPresenter.AnswerUi>
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        /**
         * M: answer_fragment is just a parent 
         * Original code:
    ...
    public void showAnswerUi(boolean show) {
        /**
         * M: only mGlowpad need to be visible/gone
         * Original code:
        ...
        if (show) {
            ...
            mGlowpad.stopPing();
            /**
             * M: [ALPS01434683]when the Answer status changed (show --> disappear),
             * the GlowPad should be reset to default status for next incoming call.
             */
        ...
        //<<hct:mingming.wu
        if (show) {
            if (android.os.SystemProperties.getBoolean("persist.sys.ng_autoanswer", false)) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //<<hct:mingming.wu
        mNextGestureDetector = new NextGestureDetector(getActivity(),
    ...
    private boolean handleIncomingMenuItemClickMTK(MenuItem item) {
        ...
        /// M:@{
        // if incoming call not exist any more, should not handle click any more
        if(!InCallPresenter.getInstance().getInCallState().isIncoming()) {
            Log.d(this,"if incoming call not exist any more, ignored~~");
            return false;
        }
        /// @}
