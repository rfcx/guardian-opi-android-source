...
public class CallButtonFragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mEndCallButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.pi("sera","[Performance test][Phone] Call_Performance_005 start [" + System.currentTimeMillis() + "]");
                /// M: @}
    ...
    public void setEnabled(boolean isEnabled) {
        /// M: For VT @{
        if (!getPresenter().isNoCallExist() || InCallPresenter.getInstance().getInCallState().isIncoming()) {
