    ...
    */
    ...
    public boolean clearOnDisconnect() {
        for (Call call : mCallMap.values()) {
            ...
            ///M: if we have incoming or outgoing call in call list,
            // do not tell UI disconnected, to avoid timing issue, ALPS01474580.
            if (state == Call.State.INCOMING || state == Call.State.DIALING) {
                return true;
            }
