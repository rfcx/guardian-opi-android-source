...
public class LauncherModel extends BroadcastReceiver {
    ...
    public static Boolean mIsCustomApkName = false;
   	public static Boolean mIsCustomApkIcon = false;
    ...
    LauncherModel(LauncherApplication app, IconCache iconCache) {
        ...
        mIsCustomApkName = res.getBoolean(R.bool.hct_config_support_custom_apk_name);
		mIsCustomApkIcon = res.getBoolean(R.bool.hct_config_support_custom_apk_icon);
