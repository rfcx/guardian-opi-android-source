...
public class Workspace extends SmoothPagedView
    ...
    protected void setWallpaperDimension() {
        ...
        if(getResources().getBoolean(R.bool.config_lock_up_wallpaper)){
    ...
    private void syncWallpaperOffsetWithScroll() {
        final boolean enableWallpaperEffects = isHardwareAccelerated() && getResources().getBoolean(
        		R.bool.config_enable_effect_wallpaper);
