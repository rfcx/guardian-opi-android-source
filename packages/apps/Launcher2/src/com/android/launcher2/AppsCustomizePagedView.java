...
public class AppsCustomizePagedView extends PagedViewWithDraggableItems implements
    ...
    private boolean mConfigTransEffect = false;
    ...
    public AppsCustomizePagedView(Context context, AttributeSet attrs) {
        ...
        mConfigTransEffect = context.getResources().getBoolean(R.bool.config_allapps_trans_effect);
    ...
    private int findAppByPackage(List<ApplicationInfo> list, String packageName) {
        final List<ResolveInfo> matches = AllAppsList.findActivitiesForPackage(mContext, packageName); // mtk add
        int length = list.size();
        for (int i = 0; i < length; ++i) {
            ApplicationInfo info = list.get(i);
