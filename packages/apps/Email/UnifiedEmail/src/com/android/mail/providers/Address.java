...
public class Address implements Parcelable {
    ...
    /**
     * M: Be careful when use this method, it will decoded the "name",
     *    The decoded a normal name result may be some messy code.
     *    if you just want to set an normal address' name, better use new Address (address, name).
     *
