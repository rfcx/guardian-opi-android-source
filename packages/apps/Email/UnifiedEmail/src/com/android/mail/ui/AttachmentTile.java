...
public class AttachmentTile extends RelativeLayout implements AttachmentBitmapHolder {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        /**
         * M: Do setup thumbnail preview just only the mThumbnailTask is null,
         * otherwise do nothing.
         *
         * @{
         */
        if (mThumbnailTask == null) {
            mThumbnailTask = ThumbnailLoadTask.setupThumbnailPreview(mThumbnailTask, this,
                    mAttachment, null);
        }
        /** @}*/
    }
    ...
    public void render(Attachment attachment, Uri attachmentsListUri, int index,
        ...
        if ((mThumbnailTask == null) || (!uri.equals(prevUri))) {
            mThumbnailTask = ThumbnailLoadTask.setupThumbnailPreview(mThumbnailTask, this, attachment, prevAttachment);
        }
        /** @}*/
    }
