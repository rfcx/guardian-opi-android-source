...
public class WidgetService extends RemoteViewsService {
    ...
    public static void configureValidWidgetIntents(Context context, RemoteViews remoteViews,
        ...
        LogUtils.d(LOG_TAG, "configureValidWidgetIntents=>intnet: %s , data : %s", intent, dataUri.toString());
        /** @} */
    ...
    protected static class MailFactory
        ...
        public void onLoadComplete(Loader<Cursor> loader, Cursor data) {
            ...
            if (loader == mFolderLoader) {
                ...
                /// M: add log
                LogUtils.d(LOG_TAG, "MailFactory : update folder total count : %d", mFolderCount);
                ...
                /// M: we need update mAccount, Cause it would has been changed, such as account name @{
                if (isDataValid(data)) {
                    mAccount = new Account(data);
                }
                BaseWidgetProvider.updateWidget(mContext, mAppWidgetId, mAccount, mFolderType,
                        mFolderUri, mFolderConversationListUri, mFolderDisplayName);
                /// @}
