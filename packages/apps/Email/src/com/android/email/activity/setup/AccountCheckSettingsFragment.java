...
public class AccountCheckSettingsFragment extends Fragment {
    ...
    // CHECKSTYLE:ON
    /** M: The "extra" name for the Bundle saved with request mode */
    private static final String EXTRA_REQUEST_CODE = "AccountCheckSettingsFragment.requestMode";
    /** @}*/

    /** M: The "extra" name for the Bundle saved with mState */
    private static final String EXTRA_CHECK_STATE = "AccountCheckSettingsFragment.checkState";
    /** @}*/
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (mAccountCheckTask == null) {
            /**
             * M: If the fragment was restored, it should be to get the
             * checkMode and mState from savedInstanceState.
             *
             * @{
             */
            final int checkMode;
            if (savedInstanceState != null) {
                checkMode = savedInstanceState.getInt(EXTRA_REQUEST_CODE,
                        getTargetRequestCode());
                setTargetFragment(getTargetFragment(), checkMode);
                mState = savedInstanceState.getInt(EXTRA_CHECK_STATE, STATE_START);
            } else {
                checkMode = getTargetRequestCode();
            }
            /** @} */
            ...
            /**
             * M:if the checking state is OK, it is no need to re-do the check
             * operations.
             *
             * @{
             */
            if (mState != STATE_CHECK_OK) {
                mAccountCheckTask = (AccountCheckTask) new AccountCheckTask(
                        checkMode, checkAccount)
                ...
                case STATE_CHECK_SHOW_SECURITY:
                    ...
                    if (fm.findFragmentByTag(SecurityRequiredDialog.TAG) == null) {
                        ...
                        fm.beginTransaction()
                                ...
                                /// M: modify to commitAllowingStateLoss, cause there was some seldom case
                                /// that call this after saveInstance...but how to do it?
                ...
                case STATE_AUTODISCOVER_AUTH_DIALOG:
                    ...
                    if (fm.findFragmentByTag(ErrorDialog.TAG) == null) {
                        ...
                        fm.beginTransaction()
                                ...
                                /// M: modify to commitAllowingStateLoss, cause there was some seldom case
                                /// that call this after saveInstance.
                                .commitAllowingStateLoss();
                    }
                    break;
    ...
    /** M: save the request code and mState @{ */
    @Override
    public void onSaveInstanceState(Bundle outState) {
        outState.putInt(EXTRA_REQUEST_CODE, getTargetRequestCode());
        outState.putInt(EXTRA_CHECK_STATE, mState);
