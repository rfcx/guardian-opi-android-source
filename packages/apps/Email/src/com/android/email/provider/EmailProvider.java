...
//                    }
        ...
        public EmailConversationCursor(final Context context, final Cursor cursor,
            ...
            if (mailbox != null) {
                ...
                LogUtils.d(Logging.LOG_TAG,
                        ...
                        " mailbox.mSyncInterval: %d, mailbox.mUiLastSyncResult: %d, mailbox.mServerId : %s",
        ...
        switch(match) {
            ...
            case UI_FOLDER:
                ...
                if (isVirtualMailbox(mailboxId)) {
                    ...
                    /// M: check unread count for CR ALPS01426463
                    final int unreadColumn = projectionList.indexOf(UIProvider.FolderColumns.UNREAD_COUNT);
                    if (c.moveToFirst()) {
                        if (unreadColumn != -1) {
    ...
    private Uri uiSendDraftMessage(final long accountId, final Bundle extras) {
        ...
        // Kick observers
        /// M: Turn "sync to network" parameter to "false" as this operation is unnecessary to upsync
        context.getContentResolver().notifyChange(Mailbox.CONTENT_URI, null, false);
        return messageUri;
    }
