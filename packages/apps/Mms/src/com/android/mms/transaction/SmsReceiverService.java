...
//        }
    ...
    private void handleHideStatus(Intent intent) {
        ...
        if (action != null && action.equals(SmsReceiver.RADIO_HIDE_STATE_STOP)) {
...
//        }
        ...
        Recycler.SmsRecycler recycler = Recycler.getSmsRecycler();
        if (recycler != null) {
            recycler.deleteOldMessagesByThreadId(context, threadId);
        } else {
            MmsLog.e(MmsApp.TXN_TAG, "Create SmsRecycler failed, maybe memory not enough");
        }
