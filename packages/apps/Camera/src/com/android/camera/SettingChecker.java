...
//        ROW_SETTING_CONTRAST,//common
    ...
    static {
                                                                    //photo     hdr    facebeauty  panorama    mav      asd       smile  motiontrack gesture livephoto  video  gangyun_beauty  single3d panorama3d
        MATRIX_MODE_STATE[ROW_SETTING_FLASH]            = new int[]{STATE_E0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_E0, STATE_E0, STATE_R0, STATE_E0, STATE_R0, STATE_E0,STATE_E0, STATE_R0, STATE_R0};//0: flash
        MATRIX_MODE_STATE[ROW_SETTING_DUAL_CAMERA]      = new int[]{STATE_E0, STATE_D0, STATE_E0, STATE_D0, STATE_D0, STATE_D0, STATE_E0, STATE_D0, STATE_E0, STATE_E0, STATE_E0,STATE_E0, STATE_D0, STATE_D0};//1: dual camera
        MATRIX_MODE_STATE[ROW_SETTING_EXPOSURE]         = new int[]{STATE_E0, STATE_R0, STATE_R0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_R0, STATE_E0, STATE_E0};//2: ev
        MATRIX_MODE_STATE[ROW_SETTING_SCENCE_MODE]      = new int[]{STATE_E0, STATE_R1, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_R0, STATE_E0, STATE_R0};//3: scence mode
        MATRIX_MODE_STATE[ROW_SETTING_WHITE_BALANCE]    = new int[]{STATE_E0, STATE_R0, STATE_R0, STATE_E0, STATE_E0, STATE_R0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_R0, STATE_E0, STATE_E0};//4: white balance
        //image properties
        MATRIX_MODE_STATE[ROW_SETTING_COLOR_EFFECT]     = new int[]{STATE_E0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_R0, STATE_E0, STATE_R0};//6: color effect
        MATRIX_MODE_STATE[ROW_SETTING_SELF_TIMER]       = new int[]{STATE_E0, STATE_E0, STATE_E0, STATE_R0, STATE_R0, STATE_E0, STATE_R0, STATE_R0, STATE_E0, STATE_R0, STATE_E0, STATE_E0, STATE_R0, STATE_R0, STATE_R0};//7: self timer
        MATRIX_MODE_STATE[ROW_SETTING_ZSD]              = new int[]{STATE_E0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0};//8: zsd
        ...
        MATRIX_MODE_STATE[ROW_SETTING_ISO]              = new int[]{STATE_E0, STATE_R0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_D0, STATE_E0, STATE_R0, STATE_E0, STATE_E0};//12: ISO
        ...
        MATRIX_MODE_STATE[ROW_SETTING_SHARPNESS]        = new int[]{STATE_E0, STATE_R0, STATE_D0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_R0, STATE_E0, STATE_E0};//30: image adjustment sharpness
        MATRIX_MODE_STATE[ROW_SETTING_HUE]              = new int[]{STATE_E0, STATE_R0, STATE_D0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_R0, STATE_E0, STATE_E0};//31: image adjustment hue
        MATRIX_MODE_STATE[ROW_SETTING_SATURATION]       = new int[]{STATE_E0, STATE_R0, STATE_D0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_R0, STATE_E0, STATE_E0};//32: image adjustment saturation
        MATRIX_MODE_STATE[ROW_SETTING_BRIGHTNESS]       = new int[]{STATE_E0, STATE_R0, STATE_D0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_R0, STATE_E0, STATE_E0};//33: image adjustment brightness
        MATRIX_MODE_STATE[ROW_SETTING_CONTRAST]         = new int[]{STATE_E0, STATE_R0, STATE_D0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_R0, STATE_E0, STATE_E0};//34: image adjustment contrast
        ...
        MATRIX_MODE_STATE[ROW_SETTING_CAMERA_FACE_DETECT]    = new int[]{STATE_E0, STATE_E0, STATE_R1, STATE_R0, STATE_R0, STATE_R1, STATE_R1, STATE_R0, STATE_R1, STATE_R0, STATE_R0,STATE_E0, STATE_R0, STATE_E0};//50: face detection
