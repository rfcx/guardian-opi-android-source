...
import com.mediatek.common.featureoption.FeatureOption; //gangyun tech add 
...
public class ModePicker extends ViewManager implements View.OnClickListener,
    ...
    public static final int MODE_VIDEO = 10;
     ...
     public static final int MODE_FACEART = 11;//gangyun tech add
    
    public static final int MODE_NUM_ALL = 12;//gangyun tech modiy 11
    ...
    private static final int[] MODE_ICON_ORDER = {0,11, 7, 8, 2, 3, 4};//gangyun tech add 11
    static {
    	MODE_ICONS_HIGHTLIGHT[MODE_PHOTO] = R.drawable.ic_mode_photo_focus;
	MODE_ICONS_HIGHTLIGHT[MODE_FACEART] = R.drawable.gy_ic_mode_faceart_focus; //gangyun tech add
	...
	MODE_ICONS_NORMAL[MODE_FACEART] = R.drawable.gy_ic_mode_faceart_normal; //gangyun tech add
	...
	mModeViews[MODE_FACEART] = (RotateImageView) view.findViewById(R.id.mode_faceart);//gangyun tech add 
