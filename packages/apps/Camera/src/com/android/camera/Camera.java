...
public class Camera extends ActivityBase implements PreviewFrameLayout.OnSizeChangedListener,
    ...
    private IMtkHdmiManager mHdmiManager; 
 	//<<hct:mingming.wu
    private NextGestureDetector mNextGestureDetector;
    //hct:mingming.wu
...
//                break;
    ...
    private void initializeCommonManagers() {
        ...
        //<<hct:mingming.wu
        mNextGestureDetector = new NextGestureDetector(this,
              new NextGestureDetector.OnNextGestureListener(){
                 public void onNext() {
                     if (mShutterManager != null && !isVideoMode()) {
    ...
    private void doOnResume() {
        ...
        if (isNonePickIntent() || isImageCaptureIntent()) {
            /**Delete by liyu 2014.11.07 
            if (isAppGuideFinished()) {
            mVoiceManager.startUpdateVoiceState();
        }
	   //*/
           //Add by liyu 2014.11.07
           mVoiceManager.startUpdateVoiceState();
        }
        ...
        //<<hct:mingming.wu
        if (android.os.SystemProperties.getBoolean("persist.sys.ng_camera", false)) {
           mNextGestureDetector.start();
        }
        //hct:mingming.wu
    }
...
//    }
        ...
        public void onModeChanged(int newMode) {
            ...
            if (mCameraActor.getMode() != newMode) {
                ...
                case ModePicker.MODE_VIDEO:
                    ...
                    break;
					//[RY_GANGYUN_CAMERA_BEAUTY] [港云美颜相机][BEGIN]
	        	case ModePicker.MODE_FACEART: //gangyun tech add
                    mCameraActor = new com.android.camera.actor.GYFaceArtActor(Camera.this);
		             break;
					 //[RY_GANGYUN_CAMERA_BEAUTY] [港云美颜相机][END]
    ...
    private void switchCamera() {
		...
		//fengchuan  auto focus
		//FocusManager.isAutoFocustrue = false;
 		//fengchuan end
    ...
    public void setViewState(int state) {
        ...
        case VIEW_STATE_NORMAL:
            ...
            if (FeatureOption.RY_GANGYUN_CAMERA_BEAUTY && mCameraActor.getMode() == ModePicker.MODE_FACEART &&  mCameraActor instanceof                   com.android.camera.actor.GYFaceArtActor){
               ((com.android.camera.actor.GYFaceArtActor)mCameraActor).onGangyunViewManagerHide(true,false);
            } 
        ...
        case VIEW_STATE_SETTING:
            ...
            /**********gangyun tech add begin*****************/
            if (FeatureOption.RY_GANGYUN_CAMERA_BEAUTY&& mCameraActor.getMode() == ModePicker.MODE_FACEART  &&  mCameraActor instanceof  com.android.camera.actor.GYFaceArtActor){
             ((com.android.camera.actor.GYFaceArtActor)mCameraActor).onGangyunViewManagerHide(false,true);
            } 
            /**********gangyun tech add end *****************/
			//[RY_GANGYUN_CAMERA_BEAUTY] [港云美颜相机][END]
            break;
