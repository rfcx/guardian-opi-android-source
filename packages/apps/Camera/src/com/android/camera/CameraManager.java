...
//[RY_GANGYUN_CAMERA_BEAUTY] [港云美颜相机][BEGIN]
    ...
    private static final int START_GY_BEAUTY = 125;
    private static final int SET_GY_BEAUTY_SMOOTH = 126;
    private static final int SET_GY_BEAUTY_WHITENING = 127;
    private static final int SET_GY_DISPLAY_CLIENT_I420 = 128;
...
//[RY_GANGYUN_CAMERA_BEAUTY] [港云美颜相机][END]
        ...
        public void handleMessage(final Message msg) {
            ...
            try {
                switch (msg.what) {
					...
					//[RY_GANGYUN_CAMERA_BEAUTY] [港云美颜相机][BEGIN]
					/* gangyun tech add begin */
					 case START_GY_BEAUTY: //
						mCamera.startGYBeauty(msg.arg1);
						break;
				    case SET_GY_BEAUTY_SMOOTH: 
						mCamera.setGYBeautySmooth(msg.arg1);
						break;
				    case SET_GY_BEAUTY_WHITENING: 
						mCamera.setGYBeautyWhitening(msg.arg1);
		        	break;
					 /* gangyun tech add end  */
					 //[RY_GANGYUN_CAMERA_BEAUTY] [港云美颜相机][END]
                    default:
    ...
    public class CameraProxy {
		...
		//[RY_GANGYUN_CAMERA_BEAUTY] [港云美颜相机][BEGIN]
	/************gangyun tech add****************/
	public void startGYBeauty(boolean isEnabled){
		mCameraHandler.obtainMessage(START_GY_BEAUTY, isEnabled ? 1 : 0, 0).sendToTarget();
	}

	public void setGYBeautySmooth(int value){
		mCameraHandler.obtainMessage(SET_GY_BEAUTY_SMOOTH, value, 0).sendToTarget();
	}

	public void setGYBeautyWhitening(int value){
		mCameraHandler.obtainMessage(SET_GY_BEAUTY_WHITENING, value, 0).sendToTarget();
	}
