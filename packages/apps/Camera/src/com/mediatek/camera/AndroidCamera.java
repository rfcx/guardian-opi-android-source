...
//[GANGYUN_CAMERA_BEAUTY] [港云美颜相机][BEGIN]
    /******gangyun tech add*******/

    public void startGYBeauty(int isEnabled){
	mCamera.startGYBeauty(isEnabled);
    }

   public void setGYBeautySmooth(int value){
   	mCamera.setGYBeautySmooth(value);
   }

   public void setGYBeautyWhitening(int value){
	mCamera.setGYBeautyWhitening(value);
   }

   /*************end**********************/
//[GANGYUN_CAMERA_BEAUTY] [港云美颜相机][END]
}
