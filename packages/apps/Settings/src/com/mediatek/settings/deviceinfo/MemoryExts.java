    ...
    private OnPreferenceChangeListener defaultWriteDiskListener = new OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            if (preference != null && preference instanceof RadioButtonPreference) {
                ...
                if("/storage/sdcard1".equals(preference.getKey())){
                    SystemProperties.set("sys.runyee.default.storage","1");
                }else{
                    SystemProperties.set("sys.runyee.default.storage","0");
                }
                Xlog.d(TAG, "Set default path : " + preference.getKey());
                Xlog.d("zhuzhibin", "Set default path : " + SystemProperties.get("sys.runyee.default.storage"));
