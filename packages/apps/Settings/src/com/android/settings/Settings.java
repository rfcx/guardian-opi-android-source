...
public class Settings extends PreferenceActivity
    ...
    private static final String[] ENTRY_FRAGMENTS = {
        ...
        CommunicationsGestureSettings.class.getName(),
        SystemGestureSettings.class.getName()
        //
    };
...
//linghuan modified for open development optional mode 
	...
	final boolean showDev = true;
        ...
        while (i < target.size()) {
            ...
            }else if(id == R.id.gesture_settings && !getResources().getBoolean(R.bool.config_show_gesture_menu)){
		target.remove(i);
	    }else if(id == R.id.tp_gesture_settings && !getResources().getBoolean(R.bool.config_show_tp_gesture_menu)){
            	target.remove(i);
            }
    ...
    public static class CustomGestureSettingsActivity extends Settings { /* empty */ }
    public static class GestureListSettingsActivity extends Settings { /* empty */ }
    public static class GestureSettingsActivity extends Settings { /* empty */ }
	public static class CommunicationsGestureSettingsActivity extends Settings{	/* empty */}
	public static class SystemGestureSettingsActivity extends Settings{	/* empty */}
