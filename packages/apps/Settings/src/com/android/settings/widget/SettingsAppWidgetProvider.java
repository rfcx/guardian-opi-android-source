...
//                        com.android.internal.R.bool.config_automatic_brightness_available)) {
                ...
                if (brightnessMode == Settings.System.SCREEN_BRIGHTNESS_MODE_AUTOMATIC) {
                    ...
                    brightness = pm.getMinimumScreenBrightnessSetting();
                    /// M: Add for WFD to disable auto brightness when enter secure mode
                    /// When toggle brightness, skip auto mode when in secure mode @{
                    int secureMode = Settings.System.getInt(context.getContentResolver(),
                            Settings.System.DISABLE_AAL);
                    if (secureMode == 0) {
                        Xlog.d(TAG, "toggleBrightness(),MAXIMUM -> AUTO");
                        brightnessMode = Settings.System.SCREEN_BRIGHTNESS_MODE_AUTOMATIC;
                    } else {
                        Xlog.d(TAG, "toggleBrightness(),MAXIMUM -> Minimum");
                        brightnessMode = Settings.System.SCREEN_BRIGHTNESS_MODE_MANUAL;
                    }
                    /// @}
                }
