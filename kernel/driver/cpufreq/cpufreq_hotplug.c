...
#define DEF_FREQUENCY_UP_THRESHOLD          (80) //80
#define DEF_SAMPLING_DOWN_FACTOR            (1)
#define MAX_SAMPLING_DOWN_FACTOR            (100000)
#define MICRO_FREQUENCY_DOWN_DIFFERENTIAL   (15) //15
#define MIN_FREQUENCY_DOWN_DIFFERENTIAL     (5)  //5
#define MAX_FREQUENCY_DOWN_DIFFERENTIAL     (20) //20
#define MICRO_FREQUENCY_UP_THRESHOLD        (85) //85
#define MICRO_FREQUENCY_MIN_SAMPLE_RATE     (30000)
#define MIN_FREQUENCY_UP_THRESHOLD          (21) //21
#define MAX_FREQUENCY_UP_THRESHOLD          (100)//100

/*
 * cpu hotplug - macro
 */
#define DEF_CPU_DOWN_DIFFERENTIAL           (10) //10
#define MICRO_CPU_DOWN_DIFFERENTIAL         (10) //10
#define MIN_CPU_DOWN_DIFFERENTIAL           (0)  //0
#define MAX_CPU_DOWN_DIFFERENTIAL           (30) //30

#define DEF_CPU_UP_THRESHOLD                (90) //90
#define MICRO_CPU_UP_THRESHOLD              (90) //90
#define MIN_CPU_UP_THRESHOLD                (50) //50
#define MAX_CPU_UP_THRESHOLD                (100)//100
...
struct cpufreq_governor cpufreq_gov_hotplug = {
       .name                   = "hotplug",
       .governor               = cpufreq_governor_hotplug,
