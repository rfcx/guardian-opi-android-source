...
public class WifiStateMachine extends StateMachine {
   ...
   /* Set the frequency band */
    ...
    /** @} */
    private static final int M_CMD_FLUSH_BSS                 = BASE + 187;
                ...
                case WifiManager.START_WPS_REG:
                    ...
                    if (wpsInfo.setup == WpsInfo.KEYPAD) {
                        ...
                        if (!TextUtils.isEmpty(wpsInfo.SSID)) {
                            wpsInfo.SSID = bytesToHexString(wpsInfo.SSID.getBytes()).toLowerCase();
                        }
                        if (!TextUtils.isEmpty(wpsInfo.key)) {
                            wpsInfo.key = bytesToHexString(wpsInfo.key.getBytes()).toLowerCase();
                        }
        ...
        BroadcastReceiver receiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (action.equals("com.mtk.beamplus.activated")) {
                    ...
                    if (iccState!=null && !iccState.equals(IccCardConstants.INTENT_VALUE_ICC_LOADED)) {
                        return;
                    }
